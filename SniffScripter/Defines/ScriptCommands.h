#ifndef _SCRIPT_COMMANDS_H
#define _SCRIPT_COMMANDS_H
...
struct ScriptInfo
{
    ...
    bool IsEmpty() const
    {
        return command == 0 && raw.data[0] == 0 && raw.data[1] == 0 && raw.data[2] == 0 && raw.data[3] == 0 &&
            raw.data[4] == 0 && raw.data[5] == 0 && raw.data[6] == 0 && raw.data[7] == 0 && raw.data[8] == 0;
    }
};
