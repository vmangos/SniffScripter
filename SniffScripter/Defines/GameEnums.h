...
inline std::string GetHitInfoName(uint32 id)
{
    switch (id)
    {
        case HITINFO_UNK0:
        ...
        case HITINFO_UNK10:
            return "HITINFO_UNK10";
        case HITINFO_UNK11:
            return "HITINFO_UNK11";
        case HITINFO_UNK12:
            return "HITINFO_UNK12";
        case HITINFO_BLOCK:
            return "HITINFO_BLOCK";
        case HITINFO_UNK14:
            return "HITINFO_UNK14";
        case HITINFO_UNK15:
            return "HITINFO_UNK15";
        ...
        case HITINFO_UNK19:
            return "HITINFO_UNK19";
        case HITINFO_UNK20:
            return "HITINFO_UNK20";
        case HITINFO_UNK21:
            return "HITINFO_UNK21";
        case HITINFO_UNK22:
            return "HITINFO_UNK22";
        case HITINFO_RAGE_GAIN:
            return "HITINFO_RAGE_GAIN";
        case HITINFO_FAKE_DAMAGE:
            return "HITINFO_FAKE_DAMAGE";
        case HITINFO_UNK25:
            return "HITINFO_UNK25";
        case HITINFO_UNK26:
            return "HITINFO_UNK26";

    }
    return "UNKNOWN";
}

inline std::string GetHitInfoNames(uint32 hitInfo)
{
...
inline std::string GetMechanicImmuneMaskName(uint32 mask)
{
    switch (mask)
    {
		case MECHANIC_CHARM:
...
inline std::string GetMechanicImmuneMaskNames(uint32 masks)
{
    std::string maskNames;
    for (uint32 i = 0; i < MAX_MECHANIC; i++)
    {
        uint32 mask = (uint32)pow(2, i);
        if (masks & mask)
        {
            if (!maskNames.empty())
				maskNames += " | ";
